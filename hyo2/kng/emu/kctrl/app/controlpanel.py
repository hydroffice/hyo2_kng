...
from hyo2.kng.emu.kctrl.app.infoviewer import InfoViewerDialog
...
class ControlPanel(QtWidgets.QWidget):
    ...
    def start_emulation(self):
        ...
        self.sis = KCtrlProcess(conn=self.child_conn, port_in=input_port, port_out=output_port, ip_out=output_ip,
                                replay_timing=self._replay_timing, verbose=self.set_verbose.isChecked())
