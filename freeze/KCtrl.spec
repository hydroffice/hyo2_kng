...
from hyo2.kng.emu.kctrl import __version__ as sis_version
...
icon_file = os.path.join('freeze', 'KCtrl.ico')
if is_darwin:
    icon_file = os.path.join('freeze', 'KCtrl.icns')
...
exe = EXE(pyz,
          ...
          name='KCtrl.%s%s' % (sis_version, beta),
          debug=False,
          strip=None,
          upx=True,
          console=True,
